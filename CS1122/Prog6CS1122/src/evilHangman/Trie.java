...
/**
 * This class defines a Trie data structure, which
 * holds words (Strings), is sorted, and is searchable.
 * 
...
public class Trie implements Iterable<String>{
	...
	/**
	 * This method iterates through the Trie and
	 * returns true if the passed word is found.
	 * 
	 * @param s - word you are looking for
	 * 
	...
	/**
	 * This method removes a word from the Trie by iterating through the
	 * Trie and calling iter.remove() when the desired word is found.
	 * 
